...
Modified version of Genshin Optimizer with a better artifact filter
...
2. Checkes the MainStat if it is same as the perfect Artifact. If yes it continues.
3. Checkes if the perfect Artifact is utilized by a Crit User if yes checkes if the Artifact has double crit substat and another substat that maches a perfect one besides the crit one. If not it trows away. If the user is not a Crit User it checkes to see if it has 3 substats that match the perfect Artifact.
5. If the Artifact is perfect it creates a card with the info of the Artifact, the list of the perfect substats and a short description about the SET.
