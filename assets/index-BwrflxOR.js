import{v as K,w as C,j as _,a9 as S,bw as w,d as t,G as m,b as e,T as a,af as x,N as f,h as n,bx as A,by as d,P as c,O as r,r as O,S as G,bz as k,bA as h,bB as l,bC as u,z as p,bD as B,bE as D,a as $,bF as T,bc as P,bG as I,bH as M,bI as N,f as j}from"./index-pYpdGbM0.js";import{L as W}from"./Link-CXLbI39I.js";var b={},R=C;Object.defineProperty(b,"__esModule",{value:!0});var g=b.default=void 0,V=R(K()),L=_;g=b.default=(0,V.default)((0,L.jsx)("path",{d:"M16.01 11H4v2h12.01v3L20 12l-3.99-4z"}),"ArrowRightAlt");function re(){S.send({hitType:"pageview",page:"/doc"});const{params:{currentTab:o}}=w("/doc/:currentTab")??{params:{currentTab:""}};return t(n,{children:[t(m,{container:!0,sx:{px:2,py:1},children:[e(m,{item:!0,flexGrow:1,children:e(a,{variant:"h6",children:"Documentation"})}),e(m,{item:!0,children:e(a,{variant:"h6",children:e(x,{color:"info",children:"Version. 2"})})})]}),e(f,{}),e(r,{children:t(m,{container:!0,spacing:1,children:[e(m,{item:!0,xs:12,md:2,children:e(n,{bgt:"light",sx:{height:"100%"},children:t(A,{orientation:"vertical",value:o,"aria-label":"Documentation Navigation",sx:{borderRight:1,borderColor:"divider"},children:[e(d,{label:"Overview",value:"",component:c,to:""}),e(d,{label:"Key naming convention",value:"KeyNaming",component:c,to:"KeyNaming"}),e(d,{label:e("code",{children:"StatKey"}),value:"StatKey",component:c,to:"StatKey"}),e(d,{label:e("code",{children:"ArtifactSetKey"}),value:"ArtifactSetKey",component:c,to:"ArtifactSetKey"}),e(d,{label:e("code",{children:"CharacterKey"}),value:"CharacterKey",component:c,to:"CharacterKey"}),e(d,{label:e("code",{children:"WeaponKey"}),value:"WeaponKey",component:c,to:"WeaponKey"}),e(d,{label:e("code",{children:"MaterialKey"}),value:"MaterialKey",component:c,to:"MaterialKey"}),e(d,{label:"Version History",value:"VersionHistory",component:c,to:"VersionHistory"})]})})}),e(m,{item:!0,xs:12,md:10,children:e(n,{bgt:"light",sx:{height:"100%"},children:e(r,{children:e(O.Suspense,{fallback:e(G,{variant:"rectangular",width:"100%",height:600}),children:t(k,{children:[e(h,{index:!0,element:e(E,{})}),e(h,{path:"/VersionHistory",element:e(ee,{})}),e(h,{path:"/MaterialKey",element:e(Z,{})}),e(h,{path:"/ArtifactSetKey",element:e(U,{})}),e(h,{path:"/WeaponKey",element:e(Y,{})}),e(h,{path:"/CharacterKey",element:e(X,{})}),e(h,{path:"/StatKey",element:e(Q,{})}),e(h,{path:"/KeyNaming",element:e(J,{})})]})})})})})]})})]})}const H=`interface IGOOD {
...
type SlotKey = "flower" | "plume" | "sands" | "goblet" | "circlet"`,q=`interface IWeapon {
  ...
  | `)}`;return t(u,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"ArtifactSetKey"}),e(n,{children:e(r,{children:e(l,{text:s})})})]})}function X(){const{t:o}=p("charNames_gen"),s=$(),{gender:i}=T(),y=`type CharacterKey
  = ${[...new Set(P)].sort().map(v=>`"${v}" //${o(`charNames_gen:${I(s.chars.LocationToCharacterKey(v),i)}`)}`).join(`
  | `)}`;return t(u,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"CharacterKey"}),e(n,{children:e(r,{children:e(l,{text:y})})})]})}function Y(){const{t:o}=p("weaponNames_gen"),s=`type WeaponKey
  = ${[...new Set(M)].sort().map(i=>`"${i}" //${o(`weaponNames_gen:${i}`)}`).join(`
  | `)}`;return t(u,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"WeaponKey"}),e(n,{children:e(r,{children:e(l,{text:s})})})]})}function Z(){const{t:o}=p("material_gen"),s=`type MaterialKey
  = ${Object.keys(N.material).sort().map(i=>`"${i}" // ${o(`${i}.name`)}`).join(`
  | `)}`;return t(u,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"MaterialKey"}),e(n,{children:t(r,{children:[t(a,{gutterBottom:!0,children:["The item names are taken from the english translation, and then converted into"," ",e(W,{component:c,to:"KeyNaming",children:e("code",{children:"PascalCase"})}),"."]}),e(l,{text:s})]})})]})}function ee(){return t(j,{display:"flex",flexDirection:"column",gap:2,children:[e(a,{gutterBottom:!0,variant:"h4",children:"Version History"}),t(n,{children:[e(r,{children:e(a,{children:"Version 1"})}),e(f,{}),e(r,{children:t(a,{children:["Created general ",e("code",{children:"IGOOD"})," format with character, weapon, artifact fields."]})})]}),t(n,{children:[e(r,{children:e(a,{children:"Version 2"})}),e(f,{}),e(r,{children:t(a,{children:["Adds ",e("code",{children:"materials"})," field to ",e("code",{children:"IGOOD"}),". All other fields remain the same. V2 is backwards compatible with V1."]})})]})]})}export{re as default};
